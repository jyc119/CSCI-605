...
public class ConcentrationClient3 {
    ...
    public ConcentrationClient3(String hostName, int portNumber) {
    ...
    public static void main(String[] args) {
        ...
        ConcentrationClient3 client = new ConcentrationClient3(args[0],
