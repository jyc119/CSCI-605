...
public class TestModExpression {
    ...
    public void testModExpressionInt() {
        Expression root = new AddExpression(new IntExpression(26), new IntExpression(10));
    ...
    public void testModExpressionComplex() {
        Expression root = new AddExpression(
                new AddExpression(new IntExpression(13), new IntExpression(10)),
                new AddExpression(new IntExpression(7), new IntExpression(20)));
